      ...
      <div className="news-container relative box-border w-full h-full overflow-hidden flex flex-col items-center justify-center" style={{ flex: 1 }}>
        ...
        >
          ...
          <div className="title-zone flex-none w-full text-center">
            <h1
              ref={titleRef}
              className={`news-title ${layout.titleSizeClass}`}
              style={{ fontSize: titleConfig.initialFontSize + 'px' }}
            >
              {data.mainTitle}
            </h1>
            <div className="news-divider mt-6"></div>
          </div>
          ...
          <div className="card-zone flex-none w-full">
            ...
            >
              {data.cards.map((card, idx) => (
                <div
                  key={idx}
                  className={`news-card flex flex-col ${layout.cardWidthClass}`}
                ...
                >
                  <div className="card-header flex items-center gap-4 mb-5">
                    ...
                    <h3 className={`news-card-title ${layout.descSizeClass}`}>
                      {card.title}
                    </h3>
                  </div>
                  <p
                    className={`news-desc ${layout.descSizeClass}`}
