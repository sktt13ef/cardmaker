...
/**
 * Ant Design 主题颜色（内联定义）
 */
const THEME_COLORS: ThemeColor[] = [
    { bg: '#ffffff', onBg: '#000000d9', icon: '#1677ff' },
    { bg: '#fafafa', onBg: '#000000d9', icon: '#1677ff' },
    { bg: '#f5f5f5', onBg: '#000000d9', icon: '#1677ff' },
    { bg: '#ffffff', onBg: '#000000d9', icon: '#1677ff' },
];

const AntDesign: React.FC<{ data: GeneratedContent; scale: number }> = ({ data, scale }) => {
    ...
    return (
        <div style={{ width: 1920, height: 1080, transform: `scale(${scale})`, transformOrigin: 'top left', overflow: 'hidden' }}>
            ...
            <style>{`
                ...
                .js-desc strong { color: #000000d9; font-weight: 600; }
                .js-desc code {
                    background: rgba(150, 150, 150, 0.1); padding: 0.1em 0.3em; border-radius: 4px;
                    font-family: 'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace;
                    font-size: 0.9em; color: #1677ff;
                }
                ...
                >
                    <div className="flex flex-col items-center gap-4">
                        <div className="flex items-center gap-3">
                            <div className="ant-blue-dot"></div>
                            <div className="ant-blue-dot" style={{ opacity: 0.6 }}></div>
                            <div className="ant-blue-dot" style={{ opacity: 0.3 }}></div>
                        </div>
                        <h1 ref={titleRef} className="text-center ant-title">
                            {data.mainTitle}
                        </h1>
                    </div>
...
export const antDesignTemplate: TemplateConfig = {
    id: 'antDesign',
    name: '中台规范界面',
    description: '中后台规范化组件风格',
    icon: 'apps',
    downloadable: true,
    ssrReady: true,
    render: (data, scale) => <AntDesign data={data} scale={scale} />,
    generateHtml: (data) => generateDownloadableHtml(data, 'antDesign'),
};
