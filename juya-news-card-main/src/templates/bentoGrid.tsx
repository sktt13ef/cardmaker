...
const BentoGrid: React.FC<BentoGridProps> = ({ data, scale }) => {
  ...
  return (
    <div style={{ width: 1920, height: 1080, transform: `scale(${scale})`, transformOrigin: 'top left', overflow: 'hidden' }}>
      ...
      <div className="bento-container relative box-border w-full h-full overflow-hidden flex flex-col items-center justify-center">
        <div
          ref={wrapperRef}
...
export const bentoGridTemplate: TemplateConfig = {
  ...
  icon: 'grid_view',
  render: (data, scale) => React.createElement(BentoGrid, { data, scale }),
